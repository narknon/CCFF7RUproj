...
#include "FairCameraNoData.h"
#include "FairCameraTransparentData.h"
#include "FairCameraFixModeData.h"
#include "FairCameraBasicParameter.generated.h"

class UCurveFloat;

USTRUCT(BlueprintType)
struct FFairCameraBasicParameter {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraRootOffsetAdjustData> RootOffsetAdjustList;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraNoData> BattleEventFinishLerpEnemyList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraFixExPointData> BattleEventFinishLerpInfoList;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraNoData> BattleEventDamageLerpCommandList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraFixExPointData> BattleEventDamageLerpInfoList;
    ...
    TArray<uint32> ReturnFocusAttackSkipCommand;
    ...
    UPROPERTY(EditAnywhere)
    TArray<uint32> AttentionCommand;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraNoData> AttentionLookAtLerpEnemyList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraFixExPointData> AttentionLookAtLerpInfoList;
    ...
    UPROPERTY(EditAnywhere)
    TArray<uint32> HeightCheckCommandList;
    ...
    UPROPERTY(EditAnywhere)
    TArray<uint32> TransparentCapsuleOnlyEnemyList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraNoData> TransparentCharacterIndexList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraTransparentData> TransparentCharacterParamList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FFairCameraNoData> TransparentCharacterBattleIndexList;
    ...
    FAIR_API FFairCameraBasicParameter();
};
