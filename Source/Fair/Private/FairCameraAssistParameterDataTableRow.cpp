#include "FairCameraAssistParameterDataTableRow.h"

FFairCameraAssistParameterDataTableRow::FFairCameraAssistParameterDataTableRow() {
    this->RootDelayEnable = false;
